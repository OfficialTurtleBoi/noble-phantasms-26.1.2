...
public final class EyeShardRenderer extends EntityRenderer<EyeShardEntity, EyeShardRenderState> {
    ...
    public void submit(EyeShardRenderState state, PoseStack poseStack,
        ...
        collector.submitCustomGeometry(poseStack, RENDER_TYPE,
                (pose, buffer) -> drawPiece(pose, buffer, layout, piece));
        poseStack.popPose();
    ...
    private static void drawPiece(PoseStack.Pose pose, VertexConsumer buffer,
        ...
        for (RelicFragmenter.Pixel pixel : piece.pixels()) {
            ...
            vertex(pose, buffer, x0, y0, halfThickness, u0, v1, 0.0F, 0.0F, 1.0F);
            vertex(pose, buffer, x1, y0, halfThickness, u1, v1, 0.0F, 0.0F, 1.0F);
            vertex(pose, buffer, x1, y1, halfThickness, u1, v0, 0.0F, 0.0F, 1.0F);
            vertex(pose, buffer, x0, y1, halfThickness, u0, v0, 0.0F, 0.0F, 1.0F);
            vertex(pose, buffer, x0, y1, -halfThickness, u0, v0, 0.0F, 0.0F, -1.0F);
            vertex(pose, buffer, x1, y1, -halfThickness, u1, v0, 0.0F, 0.0F, -1.0F);
            vertex(pose, buffer, x1, y0, -halfThickness, u1, v1, 0.0F, 0.0F, -1.0F);
            vertex(pose, buffer, x0, y0, -halfThickness, u0, v1, 0.0F, 0.0F, -1.0F);
            if (!occupied.contains(coordinate(pixel.x() - 1, pixel.y()))) {
                vertex(pose, buffer, x0, y0, -halfThickness, centerU, v1, -1.0F, 0.0F, 0.0F);
                vertex(pose, buffer, x0, y0, halfThickness, centerU, v1, -1.0F, 0.0F, 0.0F);
                vertex(pose, buffer, x0, y1, halfThickness, centerU, v0, -1.0F, 0.0F, 0.0F);
                vertex(pose, buffer, x0, y1, -halfThickness, centerU, v0, -1.0F, 0.0F, 0.0F);
            }
            if (!occupied.contains(coordinate(pixel.x() + 1, pixel.y()))) {
                vertex(pose, buffer, x1, y1, -halfThickness, centerU, v0, 1.0F, 0.0F, 0.0F);
                vertex(pose, buffer, x1, y1, halfThickness, centerU, v0, 1.0F, 0.0F, 0.0F);
                vertex(pose, buffer, x1, y0, halfThickness, centerU, v1, 1.0F, 0.0F, 0.0F);
                vertex(pose, buffer, x1, y0, -halfThickness, centerU, v1, 1.0F, 0.0F, 0.0F);
            }
            if (!occupied.contains(coordinate(pixel.x(), pixel.y() - 1))) {
                vertex(pose, buffer, x0, y1, -halfThickness, u0, centerV, 0.0F, 1.0F, 0.0F);
                vertex(pose, buffer, x0, y1, halfThickness, u0, centerV, 0.0F, 1.0F, 0.0F);
                vertex(pose, buffer, x1, y1, halfThickness, u1, centerV, 0.0F, 1.0F, 0.0F);
                vertex(pose, buffer, x1, y1, -halfThickness, u1, centerV, 0.0F, 1.0F, 0.0F);
            }
            if (!occupied.contains(coordinate(pixel.x(), pixel.y() + 1))) {
                vertex(pose, buffer, x1, y0, -halfThickness, u1, centerV, 0.0F, -1.0F, 0.0F);
                vertex(pose, buffer, x1, y0, halfThickness, u1, centerV, 0.0F, -1.0F, 0.0F);
                vertex(pose, buffer, x0, y0, halfThickness, u0, centerV, 0.0F, -1.0F, 0.0F);
                vertex(pose, buffer, x0, y0, -halfThickness, u0, centerV, 0.0F, -1.0F, 0.0F);
            }
        }
    }
