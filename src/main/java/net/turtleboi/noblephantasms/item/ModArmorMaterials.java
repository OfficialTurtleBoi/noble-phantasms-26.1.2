...
public class ModArmorMaterials {
    ...
    public static final ResourceKey<EquipmentAsset> NORSE_KEY =
            ResourceKey.create(ROOT_ID, Identifier.fromNamespaceAndPath(NoblePhantasms.MOD_ID, "norse"));

    public static final ArmorMaterial NORSE_MATERIAL = new ArmorMaterial(48,
            makeDefense(3, 6, 8, 5, 21), 21, SoundEvents.ARMOR_EQUIP_GOLD,
            3f, 0.2f, ModTags.Items.NORSE_REPAIRABLE, NORSE_KEY);
