...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addSimpleItem(ModItems.RELIC_FRAGMENTS, "Relic Fragments");
        addSimpleItem(ModItems.RELIC_FRAGMENTS_ARTHURIAN, "Arthurian Relic Fragments");
        addSimpleItem(ModItems.RELIC_FRAGMENTS_AZTEC, "Aztec Relic Fragments");
        addSimpleItem(ModItems.RELIC_FRAGMENTS_EGYPT, "Egyptian Relic Fragments");
        addSimpleItem(ModItems.RELIC_FRAGMENTS_JAPANESE, "Japanese Relic Fragments");
        addSimpleItem(ModItems.RELIC_FRAGMENTS_NORSE, "Norse Relic Fragments");
        ...
        add("menu.noblephantasms.reliquary_station.forge_unavailable", "Recover and assemble every fragment first.");
        add("menu.noblephantasms.reliquary_station.book_missing", "Craft a Mythical Reliquary to uncover the secrets of the past.");
        add("menu.noblephantasms.reliquary_station.choose_relic", "Choose a relic");
        add("menu.noblephantasms.reliquary_station.select_relic", "Choose a relic from the Mythical Reliquary");
        add("menu.noblephantasms.reliquary_station.no_selected_fragments", "No stored fragments");
        ...
        add("effect.noblephantasms.stunned", "Stunned");
        add("message.noblephantasms.relic_fragment.no_focus", "Choose a relic in the Mythical Reliquary first.");
        add("message.noblephantasms.relic_fragment.wrong_civilization", "These fragments do not belong to that civilization.");
        add("message.noblephantasms.relic_fragment.complete_set", "Every fragment for this relic has already been uncovered.");
        add("message.noblephantasms.reliquary_station.no_book", "Keep a Mythical Reliquary in your inventory.");
        add("message.noblephantasms.reliquary_station.archive_full", "Every possible fragment from that pile is already stored in this Reliquary.");
        add("message.noblephantasms.reliquary_station.collect_fragment", "Collect the revealed fragment before brushing another.");
        add("message.noblephantasms.reliquary_station.discovered", "Discovered: %s");
