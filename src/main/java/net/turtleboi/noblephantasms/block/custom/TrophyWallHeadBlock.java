...
public class TrophyWallHeadBlock extends WallSkullBlock {
    public static final MapCodec<TrophyWallHeadBlock> CODEC = simpleCodec(TrophyWallHeadBlock::new);

    public TrophyWallHeadBlock(BlockBehaviour.Properties properties) {
        super(ModSkullTypes.TROPHY, properties);
    }

    @Override
    public MapCodec<TrophyWallHeadBlock> codec() {
        return CODEC;
    }
